...
public class HibernateUtils {
	...
	@SuppressWarnings("deprecation")
	public static int getTotalCount(HibernateTemplate hibernateTemplate, final DetachedCriteria criteria)
	...
	@SuppressWarnings("deprecation")
	public static List findByCriteria(HibernateTemplate hibernateTemplate, final DetachedCriteria criteria)
			throws DataAccessException {
