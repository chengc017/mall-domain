...
/**
 * @Title: CatagoryDaoImpl.java
 * @Package com.sohu.sur.dao.admin.impl
 * @Description: TODO
 * @author leiyangbj6779
 * @date 2011-11-28 下午2:52:55
 * @version V1.0
 */
@Repository
public class SucAbstractGiftDao extends BaseHibernateDaoSupport<SucAbstractGift> {
